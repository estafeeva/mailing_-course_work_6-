...
urlpatterns = [
    ...
    path("client/<int:pk>", cache_page(60)(ClientDetailView.as_view()), name="detail_client"),
    ...
    path(
        ...
        name="list_mailingsettings",
    ),
    path(
        "mailingsettings/create",
        MailingSettingsCreateView.as_view(),
        name="create_mailingsettings",
    ),
    path(
        "mailingsettings/<int:pk>",
        cache_page(60)(MailingSettingsDetailView.as_view()),
        name="detail_mailingsettings",
    ),
    path(
        "mailingsettings/update/<int:pk>",
        MailingSettingsUpdateView.as_view(),
        name="update_mailingsettings",
    ),
    path(
    ...
    path("blog_list/blog/<int:pk>", cache_page(60)(BlogDetailView.as_view()), name="blog"),
